    ...
    def train(self, rollout):
        ...
        for _ in range(self.EPOCHS):
            ...
            for s, a, r, adv in rollout:
                ...
                while True:
                    try:
                        summary, step, state_a, state_c, _ = self.sess.run([self.summarise, self.global_step, self.pi_state_final, self.vf_state_final, self.train_op],
                                                                        feed_dict={self.pi_state_init: state_a, self.vf_state_init: state_c, self.keep_prob: 0.8})
